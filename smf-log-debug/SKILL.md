---
name: smf-log-debug
description: Diagnose missing UART output and audio-framework, VAD, or KWS logs in embedded firmware by separating compile-time inclusion, image delivery, runtime pipeline activation, log-level filtering, and flashing mistakes. Use when logs stop, show OFF, or expected diagnostic lines are absent.
---

# Audio Framework Log Debug
...
Read [references/kws-log-signatures.md](references/kws-log-signatures.md) for the included KWS case-study signatures and interpretation.
